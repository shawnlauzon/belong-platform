...
describe('createAuthService', () => {
  ...
  describe('signUp', () => {
    ...
    it('should throw error when Supabase returns error', async () => {
      ...
      // Act & Assert
      await expect(
        authService.signUp(email, password, firstName)
    ...
    it('should throw error when no user data returned', async () => {
      ...
      await expect(
        authService.signUp(email, password, firstName)
      ).rejects.toThrow('No user data returned from sign up');
    });
  ...
  describe('getCurrentUser', () => {
    it('should return complete user when authenticated', async () => {
      ...
      vi.mocked(createUserService).mockReturnValue(
        mockUserServiceInstance as any
      );
      ...
      expect(mockUserServiceInstance.fetchUserById).toHaveBeenCalledWith(
        mockUser.id
      );
    });
