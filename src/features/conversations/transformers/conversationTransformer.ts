...
export function toDomainConversation(
  ...
  const dbParticipantIds = [
    dbConversation.participant_1_id,
    dbConversation.participant_2_id,
  ].sort();

  if (
    participantIds[0] !== dbParticipantIds[0] ||
    participantIds[1] !== dbParticipantIds[1]
  ) {
