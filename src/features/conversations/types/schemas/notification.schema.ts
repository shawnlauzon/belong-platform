import { z } from 'zod';
import { caseTransform } from '../../../../shared/utils/transformers';
...
export const NotificationUpdateSchema =
  NotificationCreateSchema.partial().extend({
...
export const NotificationDbSchema = NotificationSchema.transform(
  caseTransform.toSnakeCase
);

// Transform from database with date parsing
export const NotificationFromDbSchema = z
  .any()
