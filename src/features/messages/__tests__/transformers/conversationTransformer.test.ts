...
import { transformConversation, transformCommunityConversation } from '../../transformers/conversationTransformer';
...
describe('conversationTransformer', () => {
  ...
  describe('transformCommunityConversation', () => {
    ...
    const createMockConversationRow = (overrides?: Partial<Database['public']['Tables']['conversations']['Row']>): Database['public']['Tables']['conversations']['Row'] => ({
      id: 'conversation-456',
    ...
    it('should transform community conversation row to domain object correctly', () => {
      ...
      const result = transformCommunityConversation(conversationRow, mockParticipantData, participantCount);
    ...
    it('should handle null values correctly', () => {
      ...
      const result = transformCommunityConversation(conversationRow, participantData, 5);
    ...
    it('should convert date strings to Date objects', () => {
      ...
      const result = transformCommunityConversation(conversationRow, mockParticipantData, 10);
    ...
    it('should throw error when community_id is null', () => {
      ...
      expect(() => transformCommunityConversation(conversationRow, mockParticipantData, 5))
    ...
    it('should set conversation type as community', () => {
      ...
      const result = transformCommunityConversation(conversationRow, mockParticipantData, 8);
