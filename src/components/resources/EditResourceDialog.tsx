...
const resourceSchema = z.object({
  ...
  meetup_flexibility: z.enum(['home_only', 'public_meetup_ok', 'delivery_possible']).optional(),
...
export function EditResourceDialog({ 
  ...
  useEffect(() => {
    if (resource && open) {
      logger.debug('📦 EditResourceDialog: Setting form values from resource:', resource);
      ...
      setValue('meetup_flexibility', resource.meetup_flexibility || 'home_only');
  ...
  const handleAddressChange = (address: string, coordinates: Coordinates | null, bbox?: [number, number, number, number]) => {
    logger.debug('📍 EditResourceDialog: Address changed:', { address, coordinates, bbox });
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="grid gap-6 py-4">
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-medium text-warmgray-800">Location</h3>
