...
import { CommunitySelector } from '@/components/communities/CommunitySelector';
...
export function AppLayout({ children, showCommunitySelector = true }: AppLayoutProps) {
  return (
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2 text-primary-600">
              ...
              <span className="text-sm text-warmgray-500">© 2025 Belong Network</span>
            </div>
