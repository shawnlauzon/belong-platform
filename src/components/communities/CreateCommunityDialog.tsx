...
export function CreateCommunityDialog({ 
  ...
  const parentCommunity = parentCommunityId 
    ? mockCommunities.find(c => c.id === parentCommunityId)
    : null;

  const { register, handleSubmit, formState: { errors, isSubmitting }, setValue, reset } = useForm<CommunityFormData>({
  ...
  const onSubmit = async (data: CommunityFormData) => {
    ...
    try {
      ...
      const newCommunity: Community = {
        id: `community-${Date.now()}`, // In real app, this would be generated by the backend
        name: data.name,
        description: data.description,
        level: data.level,
        parent_id: parentCommunityId || null,
      ...
      logUserAction('community_create_error', { error: error.message });
    }
  };
