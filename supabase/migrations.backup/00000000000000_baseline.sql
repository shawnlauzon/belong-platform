...
CREATE OR REPLACE FUNCTION "public"."update_trust_score"("p_user_id" "uuid", "p_community_id" "uuid", "p_action_type" "public"."trust_score_action_type", "p_action_id" "uuid", "p_points_change" integer, "p_metadata" "jsonb" DEFAULT '{}'::"jsonb") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
...
CREATE POLICY "Public can view community memberships" ON "public"."community_memberships" FOR SELECT USING (true);
...
CREATE POLICY "community_members_can_create_resource_claims" ON "public"."resource_claims" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
...
CREATE POLICY "community_members_can_create_resource_responses" ON "public"."resource_responses" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM (("public"."resources" "r"
     JOIN "public"."resource_communities" "rc" ON (("r"."id" = "rc"."resource_id")))
     JOIN "public"."community_memberships" "cm" ON (("rc"."community_id" = "cm"."community_id")))
...
CREATE POLICY "community_members_can_create_resources" ON "public"."resources" FOR INSERT TO "authenticated" WITH CHECK (("auth"."uid"() IS NOT NULL));



CREATE POLICY "community_members_can_view_resource_claims" ON "public"."resource_claims" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM (("public"."resources" "r"
     JOIN "public"."resource_communities" "rc" ON (("r"."id" = "rc"."resource_id")))
     JOIN "public"."community_memberships" "cm" ON (("rc"."community_id" = "cm"."community_id")))
  WHERE (("r"."id" = "resource_claims"."resource_id") AND ("cm"."user_id" = "auth"."uid"())))));
...
CREATE POLICY "community_members_can_view_resource_responses" ON "public"."resource_responses" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM (("public"."resources" "r"
     JOIN "public"."resource_communities" "rc" ON (("r"."id" = "rc"."resource_id")))
     JOIN "public"."community_memberships" "cm" ON (("rc"."community_id" = "cm"."community_id")))
  WHERE (("r"."id" = "resource_responses"."resource_id") AND ("cm"."user_id" = "auth"."uid"())))));
...
CREATE POLICY "community_members_can_view_resource_timeslots" ON "public"."resource_timeslots" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM (("public"."resources" "r"
     JOIN "public"."resource_communities" "rc" ON (("r"."id" = "rc"."resource_id")))
     JOIN "public"."community_memberships" "cm" ON (("rc"."community_id" = "cm"."community_id")))
...
CREATE POLICY "community_members_can_view_resources" ON "public"."resources" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
...
GRANT ALL ON TABLE "public"."resource_claims" TO "anon";
GRANT ALL ON TABLE "public"."resource_claims" TO "authenticated";
GRANT ALL ON TABLE "public"."resource_claims" TO "service_role";



GRANT ALL ON TABLE "public"."resource_communities" TO "anon";
GRANT ALL ON TABLE "public"."resource_communities" TO "authenticated";
GRANT ALL ON TABLE "public"."resource_communities" TO "service_role";



GRANT ALL ON TABLE "public"."resource_responses" TO "anon";
GRANT ALL ON TABLE "public"."resource_responses" TO "authenticated";
GRANT ALL ON TABLE "public"."resource_responses" TO "service_role";



GRANT ALL ON TABLE "public"."resource_timeslots" TO "anon";
GRANT ALL ON TABLE "public"."resource_timeslots" TO "authenticated";
GRANT ALL ON TABLE "public"."resource_timeslots" TO "service_role";
...
GRANT ALL ON TABLE "public"."shoutouts" TO "anon";
GRANT ALL ON TABLE "public"."shoutouts" TO "authenticated";
GRANT ALL ON TABLE "public"."shoutouts" TO "service_role";



GRANT ALL ON TABLE "public"."trust_score_logs" TO "anon";
GRANT ALL ON TABLE "public"."trust_score_logs" TO "authenticated";
GRANT ALL ON TABLE "public"."trust_score_logs" TO "service_role";
