-- Drop and recreate notification_details view to add resource_image_url and remove community_avatar_url
-- Also remove resource_title from metadata (it's now only in the view from the resources table)
