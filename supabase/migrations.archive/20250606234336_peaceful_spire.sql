/*
  # Fix profile trigger and policies

  1. Changes
    - Fix INSERT policy syntax (only WITH CHECK allowed for INSERT)
    - Update trigger function to use raw_user_meta_data
    - Add proper error handling and SECURITY DEFINER
...
-- Create a policy for the service role to insert profiles
