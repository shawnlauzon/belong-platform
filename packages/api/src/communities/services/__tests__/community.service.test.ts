...
import { createMockCommunity, createMockUser } from "../../../test-utils/mocks";
...
vi.mock("../transformers/communityTransformer", () => ({
  ...
  forDbInsert: vi.fn((data) => ({
    ...
    hierarchy_path: data.hierarchyPath ? JSON.stringify(data.hierarchyPath) : null,
...
describe("createCommunityService", () => {
  ...
  describe("fetchCommunities", () => {
    ...
    it("should include deleted communities when requested", async () => {
      ...
      vi.mocked(mockSupabase.from).mockReturnValue(mockQuery as any);
      mockQuery.order.mockResolvedValue({ data: mockDbCommunities, error: null });
    ...
    it("should throw error when database query fails", async () => {
      ...
      // Act & Assert
      await expect(communityService.fetchCommunities()).rejects.toThrow("Database error");
    });
  });
  ...
  describe("fetchCommunityById", () => {
    it("should fetch community by ID with organizer data", async () => {
      ...
      vi.mocked(mockSupabase.from).mockReturnValue(mockQuery as any);
      mockQuery.single.mockResolvedValue({ data: mockDbCommunity, error: null });

      // Act
      const result = await communityService.fetchCommunityById(mockCommunity.id);
    ...
    it("should throw error for other database errors", async () => {
      ...
      // Act & Assert
      await expect(communityService.fetchCommunityById("test-id")).rejects.toEqual(error);
    });
  });
  ...
  describe("createCommunity", () => {
    ...
    it("should throw error when user is not authenticated", async () => {
      ...
      // Act & Assert
      await expect(communityService.createCommunity(communityData)).rejects.toThrow(
  ...
  describe("updateCommunity", () => {
    ...
    it("should throw error when user is not authenticated", async () => {
      ...
      // Act & Assert
      await expect(communityService.updateCommunity(updateData)).rejects.toThrow(
        MESSAGE_AUTHENTICATION_REQUIRED
      );
    });
  });
  ...
  describe("deleteCommunity", () => {
    ...
    it("should throw error when user is not authenticated", async () => {
      ...
      // Act & Assert
      await expect(communityService.deleteCommunity(mockCommunity.id)).rejects.toThrow(
        MESSAGE_AUTHENTICATION_REQUIRED
      );
    });
  });
  ...
  describe("joinCommunity", () => {
    ...
    it("should throw error when user is not authenticated", async () => {
      ...
      // Act & Assert
      await expect(communityService.joinCommunity(mockCommunity.id)).rejects.toThrow(
        MESSAGE_AUTHENTICATION_REQUIRED
      );
    });
  });
  ...
  describe("leaveCommunity", () => {
    ...
    it("should throw error when user is not a member", async () => {
      ...
      // Act & Assert
      await expect(communityService.leaveCommunity(communityId)).rejects.toThrow(
