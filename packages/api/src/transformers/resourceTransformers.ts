 ...
 */
export function toDomainResource(dbResource: ResourceRow & { owner?: any }): Resource {
  if (!dbResource) {
    throw new Error(ERROR_MESSAGES.DATABASE_RESOURCE_REQUIRED);
  }

  const { owner_id, community_id, location, created_at, updated_at, ...rest } = dbResource;
  ...
  return {
    ...
    category: dbResource.category as any,
    ...
    meetup_flexibility: dbResource.meetup_flexibility as any,
 ...
 */
export function toDbResource(resource: Partial<Resource>): Partial<ResourceRow> {
