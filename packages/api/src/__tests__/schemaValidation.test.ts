...
describe('Database Schema Validation', () => {
  describe('Communities table schema', () => {
    it('should not include common misnamed fields', () => {
      ...
      const communityKeys = [
        'id', 'name', 'description', 'organizer_id', 'parent_id', 
        'created_at', 'updated_at', 'deleted_at', 'deleted_by', 'is_active',
        'level', 'member_count', 'time_zone', 'hierarchy_path', 'radius_km', 'center'
      ] as const;

      // Fields that should NOT exist (common mistakes)
      const invalidFields = [
        'updated_by', 'created_by', 'owner_id', 'user_id', 'modified_by',
        'modified_at', 'last_updated_by', 'changed_by'
      ];
  ...
  describe('Resources table schema', () => {
    it('should not include common misnamed fields', () => {
      const resourceKeys = [
        'id', 'title', 'description', 'category', 'type', 'owner_id', 
        'community_id', 'location', 'created_at', 'updated_at', 'is_active',
        'availability', 'meetup_flexibility', 'parking_info', 'pickup_instructions',
        'image_urls'
      ] as const;

      const invalidFields = [
        'updated_by', 'created_by', 'user_id', 'organizer_id', 'modified_by'
      ];
  ...
  describe('Events table schema', () => {
    it('should not include common misnamed fields', () => {
      const eventKeys = [
        'id', 'title', 'description', 'organizer_id', 'community_id',
        'start_date_time', 'end_date_time', 'location', 'coordinates',
        'parking_info', 'max_attendees', 'registration_required', 'is_active',
        'tags', 'image_urls', 'attendee_count', 'created_at', 'updated_at'
      ] as const;

      const invalidFields = [
        'updated_by', 'created_by', 'owner_id', 'user_id', 'modified_by',
        'startDate', 'endDate', 'startDateTime', 'endDateTime' // camelCase variants
      ];
  ...
  describe('Thanks table schema', () => {
    it('should not include common misnamed fields', () => {
      const thanksKeys = [
        'id', 'message', 'from_user_id', 'to_user_id', 'resource_id',
        'image_urls', 'impact_description', 'created_at', 'updated_at'
      ] as const;

      const invalidFields = [
        'updated_by', 'created_by', 'sender_id', 'recipient_id', 
        'fromUserId', 'toUserId', 'resourceId' // camelCase variants
      ];
  ...
  describe('Cross-table consistency', () => {
    it('should have consistent timestamp field patterns across schemas', () => {
      ...
      const invalidTimestampVariants = [
        ...
        'modified_at', 'modified_by', 'last_updated'
      ];
    ...
    it('should have consistent foreign key patterns', () => {
      ...
      const invalidForeignKeys = [
        'organizerId', 'ownerId', 'communityId', 
        'fromUserId', 'toUserId', 'resourceId', 'parentId',
        'user_id', 'userId' // generic user reference patterns
      ];
