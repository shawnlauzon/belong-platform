...
import {
  forDbUpdate as communityForDbUpdate,
  toDomainCommunity,
} from "../communities/transformers/communityTransformer";
import {
  forDbUpdate as resourceForDbUpdate,
  toDomainResource,
} from "../resources/transformers/resourceTransformer";
import {
  forDbUpdate as eventForDbUpdate,
  toDomainEvent,
...
import {
  ...
  createMockCommunity,
  createMockResource,
} from "../test-utils/mocks/mockDomains";
...
describe("Transformer Schema Compliance", () => {
  ...
  describe("Cross-transformer consistency", () => {
    it("should never generate updated_by field in any transformer", () => {
      ...
      const eventUpdate = eventForDbUpdate(
        { id: "test", title: "Test" },
        "user-123",
      );
