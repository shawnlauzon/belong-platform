  ...
  describe('Anti-patterns detection', () => {
    it('should document fields that commonly cause schema errors', () => {
      ...
      const commonMistakes = {
        ...
        globallyInvalid: [
          'updated_by', 'created_by', 'modified_by', 'modified_at',
          'last_updated', 'last_updated_by', 'changed_by', 'changed_at'
        ],
        ...
        camelCaseVariants: [
          'organizerId', 'ownerId', 'communityId', 'resourceId',
          'fromUserId', 'toUserId', 'parentId', 'createdAt', 'updatedAt'
        ]
      };
