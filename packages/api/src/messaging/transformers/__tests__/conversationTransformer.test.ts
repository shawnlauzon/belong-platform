...
import type { Conversation, ConversationInfo, ConversationData } from '@belongnetwork/types';
import { createMockDbConversation, createMockUser, createMockMessage } from '../../../test-utils/mocks';
import {
...
describe('conversationTransformer', () => {
  ...
  describe('toConversationInfo', () => {
    it('should transform database conversation to lightweight ConversationInfo', () => {
      ...
      // Act
      const result = toConversationInfo(dbConversation, lastMessagePreview, unreadCount);
