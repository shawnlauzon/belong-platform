...
import type { Message, MessageInfo, MessageData, User } from '@belongnetwork/types';

export type DirectMessageRow = Database['public']['Tables']['direct_messages']['Row'];
export type DirectMessageInsertDbData = Database['public']['Tables']['direct_messages']['Insert'];
