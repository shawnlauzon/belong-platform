...
export const mockResources: Resource[] = [
  {
    ...
    image_urls: [
      'https://images.pexels.com/photos/8230106/pexels-photo-8230106.jpeg',
    ],
    location: { lat: 30.251, lng: -97.7517 },
    pickup_instructions:
  ...
  },
  {
    ...
    image_urls: [
      'https://images.pexels.com/photos/1397293/pexels-photo-1397293.jpeg',
    ],
    location: { lat: 30.261, lng: -97.753 },
    pickup_instructions:
...
export const mockThanks: Thanks[] = [
  {
    ...
    image_urls: [
      'https://images.pexels.com/photos/4439908/pexels-photo-4439908.jpeg',
    ],
    impact_description:
      'Saved me at least $150 on hiring a professional cleaner.',
  ...
  },
  {
    ...
    impact_description:
      'Now I can do basic maintenance myself and save money every few months.',
  ...
  },
  {
    ...
    impact_description:
      'Made our Sunday dinner extra special and reminded me how much better homemade bread tastes.',
...
export const mockMeetupSpots: MeetupSpot[] = [
  ...
  {
    name: 'HEB (Hancock Center)',
    lat: 30.3006,
    lng: -97.7309,
    type: 'grocery',
  },
  {
    name: 'Whole Foods (Domain)',
    lat: 30.4022,
    lng: -97.7472,
    type: 'grocery',
  },
  {
    name: 'Starbucks (South Lamar)',
    lat: 30.259,
    lng: -97.7563,
    type: 'coffee',
  },
